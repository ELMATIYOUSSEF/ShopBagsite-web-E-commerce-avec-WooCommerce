    ...
    <div class="wrap">
        ...
        <form method="post" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>">
            ...
            <div>
                ...
                <input type="text" class="form-control w-100" name="name" pattern="^[a-zA-Z\s]+$" required />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" class="form-control w-100" name="subject" pattern="^[a-zA-Z0-9\s]+$" required />
            </div>
            <div>
                <label for="message">Message:</label>
                <textarea name="message" class="form-control w-100" required></textarea>
            </div>
...
add_shortcode( 'contactus', 'contact_us_plugin_shortcode' );